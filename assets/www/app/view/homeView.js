						...
						listeners : {
							...
							tap : {
								fn : function () {
									...
									Ext.getStore("YiNongStore").load({
										callback : function (records, operation, success) {
											if (success && records.lenght != 0) {
												...
												Ext.getCmp("YiNongMain").removeAll(true);
												this.config.setYiNongGrid(data, Ext.getCmp("YiNongMain"));
												Ext.getCmp("YiNongMain").setActiveItem(0);
											};
										},
										scope : this,
									});
									...
									Ext.getCmp("ZhiHuiMain").removeAll(true);
									...
									Ext.getStore("appListStore").load({
										callback : function (records, operation, success) {
											if (success && records.length != 0) {
												...
												this.config.setZhiHuiGrid(data, Ext.getCmp("ZhiHuiMain"));
												Ext.getCmp("ZhiHuiMain").setActiveItem(0);
											};
										},
										scope : this,
									});
