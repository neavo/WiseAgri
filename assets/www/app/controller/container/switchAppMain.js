Ext.define("Project.controller.container.switchAppMain", {
	extend : "Ext.app.Controller",
	config : {
		refs : {
			switchAppMain : "switchAppMain",
		},
		control : {
			switchAppMain : {
				itemtap : "onSwitchAppMainItemtap",
			},
		},
	},
	...
	onSwitchAppMainItemtap : function (list, index, target, record, e, eOpts) {
		Ext.getStore("defaultCategoryStore").load({
			callback : function (records, operation, success) {
				if (success && records.lenght != 0) {
					...
					this.loadCategory(defaultCategory, DB.otherAppMain);
					DoSwitch("otherApp");
				};
			},
			scope : this,
